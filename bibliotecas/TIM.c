...
//tipo um strtok só que pega espaços vazios
...
//lê o imóvel a partir da linha do arquivo
...
//Função para ler os dados de um arquivo binário e preencher a estrutura TImovel
